...
const Cart = () => {
  ...
  return (
    <>
    <div className={`fixed right-0 top-0 w-full lg:w-[25vw] h-full p-5 bg-gray-200 mb-3 rounded-l-lg transition-all duration-500 z-50 ${activeCart ? "translate-x-0" : "translate-x-full"} `}>
